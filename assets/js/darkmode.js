(function(){
  const css = `
:root { --bg:#ffffff; --text:#0b1220; --muted:#4b5563; --card:#f8fafc; --link:#2563eb; --border:#e5e7eb; }
html[data-theme="dark"] { --bg:#0b1220; --text:#e8eef7; --muted:#a6b0c3; --card:#0f172a; --link:#93c5fd; --border:#1f2937; }
