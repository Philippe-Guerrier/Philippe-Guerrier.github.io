...
/* HEADER - dark mode ONLY (light keeps Cayman gradient) */
html[data-theme="dark"] body .page-header{
  background-color:#0f172a !important;
  background-image:none !important;
  border-bottom:1px solid #1f2937 !important;
}
html[data-theme="dark"] body .page-header .project-name,
html[data-theme="dark"] body .page-header .project-tagline{
...
html[data-theme="dark"] body .site-footer{
  background:#0f172a !important; border-top:1px solid #1f2937 !important; color:#e8eef7 !important;
}
...
.theme-toggle{
  ...
  border:1px solid #e5e7eb; background:#f8fafc; color:#0b1220; box-shadow:0 2px 10px rgba(0,0,0,.06);
}
html[data-theme="dark"] .theme-toggle{ border-color:#1f2937; background:#0f172a; color:#e8eef7; }
`;
